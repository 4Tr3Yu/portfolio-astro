export const introPageData = {
	...
	en: {
	  ...
	  intro: 'Hi 🌎, my friends call me Atre. I’m a Full-Stack Developer🔥 with <span class="text-amber-200/90">6 years of experience</span> in various industries. I aim to create <span class="text-amber-100 font-bold">creative solutions</span> for complex puzzles. I prefer <span class="bg-gradient-to-br from-red-500 to-amber-500 font-bold bg-clip-text text-transparent">Front-End</span> 🚀, but I also enjoy modeling databases or building APIs 🤓.',
